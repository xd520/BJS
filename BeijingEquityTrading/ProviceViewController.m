...
-(void) requestData {
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERpwdManagequeryProvince] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"success"] boolValue] == YES){
            ...
            [self recivedCategoryList:[[responseObject objectForKey:@"object"] objectForKey:@"provinceList"]];
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        [self.delegate reloadProviousTableView:[dataList objectAtIndex:indexPath.row]];
